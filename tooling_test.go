...
func TestDescribeGlobal(t *testing.T) {
	...
	mux.HandleFunc("/services/data/"+apiVersion+"/tooling/sobjects/", func(w http.ResponseWriter, r *http.Request) {
...
func TestExecuteAnonymous(t *testing.T) {
	...
	mux.HandleFunc("/services/data/"+apiVersion+"/tooling/executeAnonymous/", func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
...
func TestQuery(t *testing.T) {
	...
	mux.HandleFunc("/services/data/"+apiVersion+"/tooling/query/", func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
...
func TestRunTests(t *testing.T) {
	...
	mux.HandleFunc("/services/data/"+apiVersion+"/tooling/runTestsSynchronous/", func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
...
func TestRunTestsAsynchronous(t *testing.T) {
	...
	mux.HandleFunc("/services/data/"+apiVersion+"/tooling/runTestsAsynchronous/", func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
...
func TestSearch(t *testing.T) {
	...
	mux.HandleFunc("/services/data/"+apiVersion+"/tooling/search/", func(w http.ResponseWriter, r *http.Request) {
		w.WriteHeader(http.StatusOK)
